...
if __name__ == '__main__':
    ...
    #     contratante_obj_1 = {
    #     'email': 'naoartistas@flop.com',
    #     'senha': '!Naoartistas123',
    #     'nome': 'NaoArtistas',
    #     'tipo': 'C',
    #     'celular': '21987654321',
    #     'documento': '222.333.444-55',
    #     'nome_estabelecimento': 'Só toca flop',
    #     'cep': '92201',
    #     'estado': 'CA',
    #     'cidade': 'Indio',
    #     'bairro': 'Empire Polo Club',
    #     'numero': 81,
    #     'complemento': 'Festival de música e artes.'
    # }
        ...
        # }
        # musico_obj_1 = {
        # 'email': 'taylorswift@nomusic.com',
        # 'senha': 'Taylorswift13!',
        # 'nome': 'TaylorSwiftSóCharts',
        # 'tipo': 'M',
        # 'celular': '(21)987654321',
        # 'documento': '222.333.444-55',
        # 'nome_pessoal': 'Taylor Alisson Swift',
        # 'nome_artistico': 'Taylor Swift',
        # 'descricao': 'Obcecada por charts.'
        # }

        # # Novo Musico 2
        # musico_obj_2 = {
        #     'email': 'charlixcx@popstar.com',
        #     'senha': 'brat95',
        #     'nome': 'CharliXCXBrat',
        #     'tipo': 'M',
        #     'celular': '(11)987654321',
        #     'documento': '333.444.555-66',
        #     'nome_pessoal': 'Charlotte Emma Aitchison',
        #     'nome_artistico': 'Charli XCX',
        #     'descricao': 'Streams on brat.'
        # }
