...
class ImagemTest(unittest.TestCase):
    ...
    def test_CriaImagem(self, mock_imagem, mock_session):
        ...
        mock_imagem.assert_called_once_with(dono=1, nome='foto.jpg', tipo_foto=TipoFotoEnum.PERFIL,
                                            caminho='/app/static/images/foto.jpg')
    ...
    def test_GetImagemPerfil(self, mock_query):
        self.imagem_obj = Imagem(dono=1, nome='foto.jpg', tipo_foto=TipoFotoEnum.PERFIL,
                                 caminho='/app/static/images/foto.jpg')
